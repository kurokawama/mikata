/* v0-generated — adapted from components/generated/perspectivespage/app/components/perspectives-hero.tsx */
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
          <div className="max-w-2xl">
            <Badge className="mb-5 bg-[#F59E0B]/15 text-[#F59E0B] border border-[#F59E0B]/30 text-xs font-medium px-3 py-1 rounded-full">
              世界のミカタ — 多視点ニュース
            </Badge>

            <h1
              id="hero-heading"
              className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-white leading-tight text-balance font-serif"
            >
              国別の視点で
              <br />
              ニュースを探索
            ...
            <p className="mt-5 text-[#9CA3AF] text-base sm:text-lg leading-relaxed max-w-xl">
