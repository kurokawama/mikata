    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at 70% 30%, #F59E0B 0%, transparent 70%)",
          }}
        />
        <div
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10">
          ...
          <div className="max-w-xl">
            <div className="flex items-center gap-2 mb-4">
              <div
                className="flex items-center gap-1.5 px-3 py-1 rounded-full border border-[#F59E0B]/30 bg-[#F59E0B]/10"
                aria-hidden="true"
              >
            ...
            <h2
              id="premium-heading"
              className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-white leading-tight text-balance"
            ...
            <p
              className="mt-4 text-[#9CA3AF] text-base leading-relaxed"
              style={{ fontFamily: "'Work Sans', sans-serif" }}
            >
            ...
            <ul className="mt-6 space-y-3" role="list" aria-label="プレミアム特典">
              {perks.map((perk) => (
                ...
                >
                  <Check
                    className="h-4 w-4 text-[#22C55E] flex-shrink-0 mt-0.5"
                    aria-hidden="true"
                  />
          ...
          <div className="w-full lg:w-72 flex-shrink-0">
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
              <div className="flex items-center justify-between mb-5">
                ...
                <div
                  className="flex items-center justify-center w-12 h-12 rounded-xl bg-[#F59E0B]/10 border border-[#F59E0B]/20"
                  aria-hidden="true"
                >
              ...
              <Button
                className="w-full h-11 font-semibold text-sm bg-[#F59E0B] hover:bg-[#D97706] text-[#1A1A2E] rounded-xl transition-colors focus-visible:ring-2 focus-visible:ring-[#F59E0B] focus-visible:ring-offset-2 group"
                style={{ fontFamily: "'Work Sans', sans-serif" }}
                tabIndex={0}
